...
const STUDIO_ASSET_ORIGIN = (import.meta.env.VITE_SIGNATURE_ASSET_ORIGIN || 'https://finchat.ca').replace(/\/+$/u, '')
          ...
          <table cellpadding="0" cellspacing="0" border="0" role="presentation" style="border-collapse:collapse;">
            <tr>
              <td style="padding:0 0 9px 0;font-family:'Aptos','Segoe UI','Helvetica Neue',Arial,sans-serif;font-size:12px;line-height:1.35;font-weight:500;letter-spacing:0;color:#475569;">
                ${escapeHtml(data.signoff || 'Sincerely')}
              </td>
            </tr>
          </table>
                      ...
                      ? `
                        ...
                        ${affiliationRows
                          .map(
                            (row, index) => `
                              <tr>
                                <td style="padding:${index === 0 ? '0' : '1px 0 0 0'};font-family:'Aptos','Segoe UI','Helvetica Neue',Arial,sans-serif;font-size:12.8px;line-height:1.35;font-weight:${index === 0 ? '600' : '400'};letter-spacing:0;color:${index === 0 ? '#1e293b' : '#64748b'};">
                                  ${escapeHtml(row)}
                                </td>
                              </tr>
                            `,
